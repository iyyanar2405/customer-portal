...
import { ServiceNowClient, ServiceNowConfig, ServiceNowFeatureLoadOptions } from './service-now.models';
import {
  ServiceNowCssClass,
  ServiceNowFeature,
  ServiceNowSysId,
...
export class ServiceNowService {
  ...
  openCatalogItemSupport(openOnLoad = true): void {
    this.openServiceNowSupport(
      ServiceNowFeature.CATALOG_ITEM,
      {} as Partial<BaseServiceNowParams>,
      openOnLoad,
    );
  }
  ...
  openCompanySettingsSupport(
    ...
    this.openServiceNowSupport(
      ServiceNowFeature.DNV_COMPANYSETTINGS,
      params,
      openOnLoad,
    );
  }
  ...
  private openServiceNowSupport<T extends Partial<BaseServiceNowParams>>(
    ...
    this.initServiceNow({
      ...
      loadFeature: {
        feature,
        openOnLoad,
        params: feature !== ServiceNowFeature.HOME
          ? { id: ServiceNowSysId, sys_id: sysId, ...params }
          : {}
      }
    });
  }
